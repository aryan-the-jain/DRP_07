...
export const CALM_TABS: SubTab[] = [
  { href: "/calm/breathe", label: "Breathe", metricId: "calm-breathe" },
  { href: "/calm/steady", label: "Reset focus", metricId: "calm-steady" },
  { href: "/calm/meditation", label: "Meditation", metricId: "calm-meditation" },
];
